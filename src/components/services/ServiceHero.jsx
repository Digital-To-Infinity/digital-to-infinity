        ...
        <section className="relative pt-32 pb-10 overflow-hidden">
            ...
            <div className="relative z-10 w-full mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                    ...
                    <h1 className="text-7xl max-[769px]:text-6xl max-[426px]:text-[32px] max-[376px]:text-[28px] max-[321px]:text-[24px] font-extrabold text-white tracking-tight mb-6">
                        Everything Your Business <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">
                            Needs to Grow Online
                        </span>
                    </h1>
                    <p className="text-xl max-[426px]:text-base text-slate-400 max-w-5xl mx-auto leading-relaxed">We don't just give you tools. We show you how they help you get more customers, leads, and revenue.</p>
                </motion.div>
            </div>
        </section>
    );
