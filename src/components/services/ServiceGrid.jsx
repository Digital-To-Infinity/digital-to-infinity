...
const ServiceGrid = () => {
    return (
        <section className="py-16 max-[426px]:py-12 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-6xl max-[769px]:text-5xl max-[426px]:text-4xl max-[376px]:text-3xl font-black text-slate-900 tracking-tight mb-6">
                    ...
                    <p className="text-xl max-[426px]:text-lg max-[376px]:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
