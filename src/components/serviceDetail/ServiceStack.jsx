        ...
        <section className="relative py-16 overflow-hidden bg-white">
            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 mb-20">
                    ...
                    >
                        <h1 className="text-6xl md:text-7xl font-black text-slate-900 leading-[1.05] tracking-tight mb-2">
                            Solve Your <br />
                            <span className="relative text-5xl md:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 animate-gradient bg-[length:200%_auto] pb-4 inline-block">
                                {service.title}.
                    ...
                    <div className="w-full md:w-[30%] flex md:justify-end">
                        <motion.button
                            ...
                            className="w-full md:w-auto px-10 py-5 bg-violet-600 hover:bg-violet-700 text-white rounded-2xl font-bold shadow-2xl shadow-violet-200 transition-all hover:-translate-y-1 active:translate-y-0 cursor-pointer flex items-center justify-center gap-3 group"
                        >
                            Get Free Analysis
                            ...
                            return (
                                ...
                                >
                                    <div className="p-6 md:p-8 flex items-center gap-6">
                                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-500 ${isExpanded ? 'bg-violet-600 text-white scale-110 shadow-lg shadow-violet-200' : `${colors.iconBg} ${colors.iconColor}`
                                            }`}>
                                            <Icon className="w-7 h-7" />
                                        </div>

                                        <div className="flex-1">
                                            <h3 className={`text-xl md:text-2xl font-bold transition-colors ${isExpanded ? 'text-slate-900' : 'text-slate-700 group-hover:text-violet-600'
                                                }`}>
                                                {item.title}
                                            </h3>
                                        </div>
